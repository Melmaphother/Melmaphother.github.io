...
function toggleProjects() {
  ...
  const toggleHeader = document.getElementById('projects-toggle-header');
  toggleHeader.textContent = showingSelectedProjects ? 'Selected Projects and Competitions' : 'All Projects and Competitions';
}
